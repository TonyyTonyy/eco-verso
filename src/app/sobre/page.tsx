  ...
  const timelineEvents = [
    {
      year: "2023",
      title: "O Início",
      description: "O EcoVerso foi criado com o objetivo de incentivar a educação ambiental com jogos e atividades interativas.",
    },
    {
      year: "2023",
      title: "Primeira Apresentação",
      description: "Apresentação do protótipo inicial aos colegas e professores, com feedback positivo.",
    },
    {
      year: "2024",
      title: "Melhorias no Material",
      description: "Aprimoramento dos materiais educativos baseado no feedback dos primeiros participantes.",
    },
    {
      year: "2025",
      title: "Site Simples",
      description: "Lançamento de um site básico para compartilhar os materiais desenvolvidos no projeto.",
    },
  ]
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Conheça nossa jornada, missão e a equipe por trás da plataforma de educação ambiental interativa do EcoVerso.
        </p>
      </div>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold mb-8 text-center">Conheça Nossa Equipe</h2>
